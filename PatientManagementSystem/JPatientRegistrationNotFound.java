 ...
 * @author esmasert
 */
public class JPatientRegistrationNotFound extends javax.swing.JFrame {
     ...
     */
    public JPatientRegistrationNotFound() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JPatientRegistrationNotFound.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JPatientRegistrationNotFound().setVisible(true);
            }
        });
    }
