 ...
 * @author esmasert
 */
public class JNewPatient extends javax.swing.JFrame {
    ...
    public JNewPatient() {
        ...
        setDefaultCloseOperation(JNewPatient.DISPOSE_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JNewPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JNewPatient().setVisible(true);
            }
        });
    }
    ...
    private void btnYeniHastaKaydetveRndBilgEkleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnYeniHastaKaydetveRndBilgEkleActionPerformed
        ...
        if (txtIsimSoyisim.getText().equals("") || txtTcNo.getText().equals("") || txtDogumTarihi.getText().equals("") || txtTelNo.getText().equals("") || txtAdres.getText().equals("")) {
            ...
            try {
                            ...
                            if (Integer.parseInt(DTgun) > 31) {
                                ...
                                if (Integer.parseInt(DTay) > 12) {
                                    ...
                                    if (Integer.parseInt(DTyil) > currYear) {
                                        ...
                                        // Save and open new frame //

                                        JNewPatientAppointmentInf YeniHastaRandevuBilgileriFrame = new JNewPatientAppointmentInf();
                ...
                Logger.getLogger(JNewPatient.class.getName()).log(Level.SEVERE, null, ex);
            }
